"""ORM-models for AI analysis, detected objects, and review actions."""
...
from app.models.enums import AIDetectionDecision, AIDetectionReviewAction, AIDetectionStatus


class AIDetection(Base):
    """One AI analysis session for a media file."""
...
class AIDetectionObject(Base):
    """A single detected object within one AI analysis."""
...
class AIDetectionCandidate(Base):
    """A candidate item match for one detected object."""
...
class AIDetectionReview(Base):
    """Audit log of user actions in AI review."""
